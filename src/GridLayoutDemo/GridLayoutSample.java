 ...
 */
    private GridPane addGridPane() {
        ...
        ImageView imageHouse = new ImageView(
                    new Image(LayoutSample.class.getResourceAsStream("/graphics/java.png")));
 ...
 */
    private TilePane addTilePane() {
        ...
        ImageView pages[] = new ImageView[8];
//        pages[0] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java0.png")));
//        pages[1] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java1.png")));
//        pages[2] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java2.png")));
//        pages[3] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java3.png")));
//        pages[4] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java4.png")));
//        pages[5] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java5.png")));
//        pages[6] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java6.png")));
//        pages[7] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java7.png")));
        
        for (int i=0; i<8; i++) {
            try {            
            pages[i] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java" + i + ".png")));
      //      pages[i] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java"+(i+1)+".png")));

      //      pages[i] = new ImageView(new Image(LayoutSample.class.getResourceAsStream("/graphics/java.png")));
